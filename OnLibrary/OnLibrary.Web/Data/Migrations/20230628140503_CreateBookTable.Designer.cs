...
namespace OnLibrary.Web.Data.Migrations
{
    ...
    [Migration("20230628140503_CreateBookTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnLibrary.Domain.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnLibrary.Domain.Entities.BookAuthor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnLibrary.Domain.Entities.Publication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnLibrary.Domain.Entities.Book", b =>
                {
                    b.HasOne("OnLibrary.Domain.Entities.Publication", "Publication")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("OnLibrary.Domain.Entities.BookAuthor", b =>
                {
                    b.HasOne("OnLibrary.Domain.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnLibrary.Domain.Entities.Book", "Book")
                        .WithMany("Authors")
